...
def mailer():
    ...
    #recipients = ['a.singh@boutiqaat.com']
    recipients = ['a.verma@boutiqaat.com', 'm.selvaraj@boutiqaat.com', 'y.raghav@boutiqaat.com', 'h.padode@boutiqaat.com', 'n.sangeeth@boutiqaat.com','a.singh@boutiqaat.com','g.rai@boutiqaat.com']
...
'''
30 05 * * * (cd /home/amit/anomaly_detection && . venv/bin/activate && python order_std.py && echo 'DONE' && echo `date -u`) > /home/amit/logs/mailer.log 2>&1
'''
